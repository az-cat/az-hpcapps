...
PACKAGE=STRUCTURES_182_LINX64.tar
...
wget "${HPC_APPS_STORAGE_ENDPOINT}/ansys-mech-18/${PACKAGE}?${HPCAPPS_SASKEY}" -O ${PACKAGE}
tar -xvf ${PACKAGE}
...
./INSTALL -silent -install_dir "$INSTALL_DIR/" -nohelp
